...
/**
 * Reads all the frames of a .gif and puts them into a TextureRegions Array
 * GifDecoder is needed as libgdx does not natively support the use of gifs for animation
 *
 * @author Johannes Borchardt (Copyright)
 * @author Anton Persson (LibGdx conversion 2014)
 * @author Bornander
 */
